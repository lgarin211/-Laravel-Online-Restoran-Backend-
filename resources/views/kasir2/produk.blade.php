...
@section('content')
    <!-- stoppp -->
    <div class="listview-title mt-2">Produk and Order</div>
    <ul class="listview image-listview">
                                ...
                                <div class="row gx-4 gx-lg-5 align-items-center">
                                    <div class="col-md-6">
                                        <img class="card-img-top mb-5 mb-md-0"
                                            src="{{ url('/public/cs1/' . $index->img_item) }}"
                                            id='imgitem{{ $key }}'>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="d-flex">
                                            ...
                                            <input type="hidden" value="{{ $index->nama_item }}"
                                                id="{{ 'produk' . $key }}">
                                            <input type="hidden" value="{{ $index->harga_item }}"
                                                id="{{ 'price' . $key }}">
        ...
        <script>
            ...
            if (sessionStorage.getItem('datapesanan') == null) {
                datapesanan = [];
                totalhargapesanan = 0;
            } else {
                datapesanan = JSON.parse(sessionStorage.getItem('datapesanan'));
                totalhargapesanan = parseInt(sessionStorage.getItem('totalhargapesanan'));
            }

            console.log(datapesanan, totalhargapesanan);
            ...
            additem = (id) => {
                ...
                var data = {
                    ...
                    'img': document.getElementById('imgitem' + id).src
                }
